// Jdenticon 1.7.0 | jdenticon.com | zlib licensed | (c) 2014-2017 Daniel Mester Pirttijärvi
...
a=new E(a,c);A(a,w(b)||x(b),c,0,F())};l.toSvg=function(a,b,c){var d=new K(b);A(new D(d),w(a)||x(a),b,c,F());return d.toString()};l.update=y;l.version="1.7.0";v&&(v.fn.jdenticon=function(a,b){this.each(function(c,d){y(d,a,b)});return this});"function"===typeof setTimeout&&setTimeout(l,0);return l});